...
const LAPTOP_COOLING_BASE_BRANDS = [
  "Cooler Master",
  "Antryx",
  "Teros",
  "Otros",
...
const createInitialFormData = (category = "") => ({
  ...
  type:
    category === "COOLER"
      ...
      : category === "STORAGE"
        ? "SSD 2.5"
        : INITIAL_FORM_DATA.type,
  resolution:
    category === "WEBCAM" || category === "CAPTURE_CARD"
      ? "FHD"
      : INITIAL_FORM_DATA.resolution,
  fps:
    category === "WEBCAM" || category === "CAPTURE_CARD"
      ? "30"
      : INITIAL_FORM_DATA.fps,
  fanCount:
    category === "LAPTOP_COOLING_BASE" ? "1" : INITIAL_FORM_DATA.fanCount,
  connectivity:
    category === "LAPTOP_COOLING_BASE"
      ? "USB-A"
      : INITIAL_FORM_DATA.connectivity,
  connection:
    category === "HEADSET" ? "Cableado" : INITIAL_FORM_DATA.connection,
  supportedConnections:
    category === "HEADSET"
      ? ["Cable USB"]
      : [...INITIAL_FORM_DATA.supportedConnections],
  cableHubType:
    category === "CABLE_HUB" ? "Cable" : INITIAL_FORM_DATA.cableHubType,
  cableType:
    category === "CABLE_HUB" ? "HDMI a HDMI" : INITIAL_FORM_DATA.cableType,
  cableLengthMeters:
    category === "CABLE_HUB" ? "1" : INITIAL_FORM_DATA.cableLengthMeters,
  hubInputType:
    category === "CABLE_HUB" ? "USB-C" : INITIAL_FORM_DATA.hubInputType,
...
export default function AddProductPage() {
  ...
  const handleChange = (e: any) => {
    ...
    if (
      type !== "number" &&
      NO_NEGATIVE_TEXT_FIELDS.has(name) &&
      value.includes("-")
    ) {
      e.target.value = String(formData[name as keyof typeof formData] ?? "");
      return;
    ...
    if (name === "cpuBrand") {
      ...
      setFormData({
        ...formData,
        cpuBrand: value,
        socket: nextSockets.includes(formData.socket)
          ? formData.socket
          : nextSockets[0] || "",
      });
      return;
    ...
    if (name === "keyboardType") {
      setFormData({
        ...
        switchType:
          value === "Mecanico" || value === "Magnetico"
            ? formData.switchType
            : "",
      });
      return;
    ...
    if (name === "connection" && formData.category === "HEADSET") {
      ...
      const nextSupported = formData.supportedConnections.filter((item) =>
        allowed.includes(item),
      );
      setFormData({
        ...formData,
        connection: value,
        supportedConnections: nextSupported.length
          ? nextSupported
          : [allowed[0]],
      });
      return;
    ...
    if (name === "cableHubType") {
      setFormData({
        ...
        cableLengthMeters:
          value === "Cable" ? formData.cableLengthMeters || "1" : "",
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      Object.entries(buildProductPayload(formData, { mode: "create" })).forEach(
        ([key, value]) => {
      ...
      >
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              <div className="col-span-2">
                <span className="label-admin">
                  Imagenes del Producto (Maximo 5)
                </span>
                <ImageUploader
                  mode="product"
                  files={imageFiles}
            ...
            <div className="grid grid-cols-2 gap-6 relative z-10">
                ...
                <>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="input-admin"
                    >
                      {(CPU_SOCKETS_BY_BRAND[formData.cpuBrand] || []).map(
                        (s) => (
                  ...
                  <div>
                    <label
                      htmlFor={fieldId("integratedGraphics")}
                      className="label-admin"
                    >
                      Graficos Integrados
                    </label>
                  ...
                  <div>
                    <label
                      htmlFor={fieldId("includesCooler")}
                      className="label-admin"
                    >
                      Incluye Cooler?
                    </label>
                      ...
                      {M2_FORM_FACTORS.map((size) => (
                        ...
                        >
                          <input
                            ...
                            type="checkbox"
                            checked={formData.supportedM2FormFactors.includes(
                              size,
                            )}
                            onChange={() =>
                ...
                <>
                  ...
                  <div>
                    ...
                    <span className="text-xs text-red-500">
                      Vital para validar con Case.
                    </span>
                  </div>
                  <div>
                    <label
                      htmlFor={fieldId("gpuPowerWatts")}
                      className="label-admin"
                    >
                  ...
                  <div>
                    <label
                      htmlFor={fieldId("recommendedPsuWatts")}
                      className="label-admin"
                    >
              ...
              {formData.category === "CASE" && (
                <>
                  ...
                  <div>
                    <label
                      htmlFor={fieldId("radiatorSupportMm")}
                      className="label-admin"
                    >
                      Soporte Radiador Liquido
                    </label>
                    <select
                      id={fieldId("radiatorSupportMm")}
                      name="radiatorSupportMm"
                ...
                <>
                  ...
                  <div className="col-span-2">
                    ...
                    <div className="flex gap-4 mt-2">
                      ...
                      <label
                        htmlFor={fieldOptionId("type", "Liquida")}
                        className="inline-flex items-center gap-2 border p-3 rounded-lg cursor-pointer hover:bg-blue-50"
                      >
                        <input
                          id={fieldOptionId("type", "Liquida")}
                          type="radio"
                          name="type"
                          value="Liquida"
                          checked={formData.type === "Liquida"}
                          onChange={handleChange}
                        />
                        <span>Liquida</span>
                      </label>
                      ...
                      {COOLER_SOCKET_OPTIONS.map((socket) => (
                        ...
                        >
                          <input
                            ...
                            type="checkbox"
                            checked={formData.compatibleSockets.includes(
                              socket,
                            )}
                            onChange={() =>
                              handleMultiSelectChange(
              ...
              {formData.category === "STORAGE" && (
                <>
                  ...
                  {(formData.type === "NVMe M.2" ||
                    formData.type === "M.2 SATA") && (
                    <div>
                      <label
                        htmlFor={fieldId("interface")}
                        className="label-admin"
                      >
                        Generacion
                      </label>
              ...
              {(formData.category === "LAPTOP" ||
                ...
                <>
                  ...
                  <div>
                    <label
                      htmlFor={fieldId("hasDedicatedGpu")}
                      className="label-admin"
                    >
                  ...
                  {formData.category === "LAPTOP" && (
                    <>
                      ...
                      <div>
                        <label
                          htmlFor={fieldId("includesWindows")}
                          className="label-admin"
                        >
              ...
              {formData.category === "MONITOR" && (
                <>
                  ...
                  <div>
                    <label
                      htmlFor={fieldId("responseTimeMs")}
                      className="label-admin"
                    >
                      ...
                      {MONITOR_PORTS.map((port) => (
                        ...
                        >
                          <input
                            ...
                            onChange={() =>
                              handleMultiSelectChange("ports", port)
                            }
                          />
                          <span>{port}</span>
                        </label>
              ...
              {formData.category === "KEYBOARD" && (
                <>
                      ...
                      {PERIPHERAL_CONNECTIONS.map((connection) => (
                        ...
                        >
                          <input
                            ...
                            onChange={() =>
                              handleMultiSelectChange("connections", connection)
                            }
                          />
                  ...
                  <div>
                    <label
                      htmlFor={fieldId("layoutLanguage")}
                      className="label-admin"
                    >
                      Idioma / Layout
                    </label>
                  ...
                  <div>
                    <label
                      htmlFor={fieldId("keyboardFormFactor")}
                      className="label-admin"
                    >
                      Formato de teclado
                    </label>
                ...
                <>
                  ...
                  {formData.cableHubType === "Cable" && (
                    <>
                      ...
                      <div>
                        <label
                          htmlFor={fieldId("cableLengthMeters")}
                          className="label-admin"
                        >
                          Largo en metros
                        </label>
                      ...
                      {(formData.connection === "Cableado"
                        ...
                        >
                          <input
                            ...
                            type="checkbox"
                            checked={formData.supportedConnections.includes(
                              option,
                            )}
                            onChange={() =>
                              handleMultiSelectChange(
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="bg-yellow-50 p-4 rounded-xl border border-yellow-200 text-sm text-yellow-800">
            <strong>Tip: Tip:</strong> Asegurate de elegir la categoria correcta
            para que el producto aparezca en los filtros de busqueda de la
            tienda.
          </div>
        </div>
      </form>
